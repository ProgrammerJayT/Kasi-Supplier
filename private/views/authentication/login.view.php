...
<body style="background: rgb(0,0,0);padding-bottom: 100px;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <form class="d-lg-flex flex-column align-items-lg-center">
                    ...
                    <div style="margin-top: 10px;width: 80%;"><input class="form-control" type="email" style="border-radius: 20px;text-align: center;" required="" name="email" placeholder="Registered mail address" inputmode="email"></div>
                    <div style="margin-top: 10px;width: 80%;"><input class="form-control" type="password" style="border-radius: 20px;text-align: center;" required="" name="password" placeholder="Password" minlength="8" maxlength="15"></div>
